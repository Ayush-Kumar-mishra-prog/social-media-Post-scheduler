        ...
        <div className="relative group mt-12">
          ...
          <div className="absolute bottom-4 right-2.5 flex items-center gap-3 text-sm">
            ...
            >
              ...
              <div
                className={`relative inline-flex h-5 w-9 shrink-0 cursor-pointer rounded-full transition-colors duration-200 ease-in-out focus:outline-none ${generateImages ? "bg-red-500" : "bg-slate-200"}`}
              >
                <span
                  className={`pointer-events-none size-4 transform translate-y-0.5 rounded-full bg-white transition ${generateImages ? "translate-x-4.5" : "translate-x-0.5"}`}
                />
              </div>
            </button>
            <button
